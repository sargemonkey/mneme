...
internal static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        var evaluator = new LoCoMoEvaluator(dataRoot, embedder, answerer, judge, distiller, reranker, planner, ingestMode, topK, concurrency, recallRetry, categories, args.Contains("--reuse-db"), args.Contains("--entity-boost"), kgExtractor, !args.Contains("--no-subject-boost"), args.Contains("--kg-supplement"));
        ...
        BuildClients(string[] args)
    {
        ...
        return (embedder, chat, chat, new LlmSessionDistiller(chat, kgTriples),
